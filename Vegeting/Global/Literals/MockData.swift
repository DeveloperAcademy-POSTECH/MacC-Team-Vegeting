...
class MockData {
    static let club = [Club(clubID: "", chatID: "", clubTitle: "동물해방 같이 읽어요.", clubCategory: "공부", clubContent: "랄랄라", clubLocation: "포항효자동", hostID: "a",participants: participant, createdAt: Date(), maxNumberOfPeople: 10, coverImageURL: "groupCoverImage1"),
                       Club(clubID: "", chatID: "", clubTitle: "매주 금요일마다 플로깅 하러 가실 분??", clubCategory: "맛집", clubContent: "랄랄라", clubLocation: "포항효자동", hostID: "a", participants: participant, createdAt: Date(), maxNumberOfPeople: 11, coverImageURL: "groupCoverImage2"),
                       Club(clubID: "", chatID: "", clubTitle: "매주 금요일마다 플로깅 하러 가실 분??", clubCategory: "친목", clubContent: "랄랄라", clubLocation: "포항효자동", hostID: "a", participants: participant, createdAt: Date(), maxNumberOfPeople: 12, coverImageURL: "groupCoverImage3"),
                       Club(clubID: "", chatID: "", clubTitle: "남미플랜트랩하고 거북이 먹으러 가요~!", clubCategory: "공부", clubContent: "랄랄라", clubLocation: "포항효자동", hostID: "a", participants: participant, createdAt: Date(), maxNumberOfPeople: 13, coverImageURL: "groupCoverImage2"),
                       ...
                       Club(clubID: "", chatID: "", clubTitle: "동물권 관련 스터디", clubCategory: "맛집", clubContent: "랄랄라", clubLocation: "포항효자동", hostID: "a", participants: participant, createdAt: Date(), maxNumberOfPeople: 15, coverImageURL: "groupCoverImage3"),
